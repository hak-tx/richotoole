        ...
        <div className="flex justify-center mt-5">
          <div className="flex gap-6 items-center flex-wrap justify-center">
            <ScrollReveal animation="fade-up" delay={0}>
              <a href="https://music.apple.com/us/artist/rich-otoole/191054733?app=itunes" target="_blank" rel="noopener noreferrer" className="music-link" style={{ borderColor: "#a855f7" }}>
            ...
            <ScrollReveal animation="fade-up" delay={150}>
              <a href="https://open.spotify.com/artist/2t6FHAUXxi9eiatP2Mavh0?si=dEC64sG_RWiXFDDvVFPVtA" target="_blank" rel="noopener noreferrer" className="music-link" style={{ borderColor: "#1DB954" }}>
            ...
            <ScrollReveal animation="fade-up" delay={300}>
              <a href="https://music.apple.com/us/artist/rich-otoole/191054733" target="_blank" rel="noopener noreferrer" className="music-link" style={{ borderColor: "#fc3c44" }}>
